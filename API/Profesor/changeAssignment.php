...
if (!isset($_SESSION["usuario"]) || $_SESSION["usuario"]["tipo"] != 1) {
    ...
    if ($con->connect_errno) {
        ...
        if (isset($_POST["fechaEntrega"])) {
            $fechaEntrega = "fechaEntrega='" . $con->real_escape_string($_POST["fechaEntrega"]) . "',";
        } else {
            $fechaEntrega = "NULL";
        }
        ...
        $query = "UPDATE actividad SET texto='$texto',paginas='$paginas',$fechaEntrega titulo='$titulo' WHERE idActividad='$idActividad'";
